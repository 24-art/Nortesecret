...
export class CategoriesController {
  ...
  @Get()
  @ApiOperation({ summary: 'Listar todas las categorias de productos activas' })
  @ApiOkResponse({
    description: 'Listado de categorias de productos activas',
    type: CategoryEntity,
    isArray: true,
  })
  getAllCategories() {
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Obtener una categoria de producto por su ID' })
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Desactivar una categoria de producto' })
  @ApiParam({ name: 'id', description: 'ID de la categoria', example: 1 })
  @ApiOkResponse({
